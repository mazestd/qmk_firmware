...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_split_bs(
        KC_F1, KC_F6,   KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSLS, KC_DEL, KC_HOME,
        KC_F2, KC_F7,     KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC,    KC_BSPC,   KC_END,
        KC_F3, KC_F8,       KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,      KC_ENT,     KC_PGUP,
        KC_F4, KC_F9,   KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, KC_PGDN,
        KC_F5, KC_F10,  KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, KC_LEFT, KC_DOWN, KC_RIGHT
    ),

    [_MOD] = LAYOUT_split_bs(
...
static void print_status_narrow(void) {
    ...
    switch (get_highest_layer(layer_state)) {
        ...
        case _MOD:
            ...
            break;
        case _MORE:
            oled_write("More", false);
            break;
        case _ADD:
            oled_write("Addon", false);
            break;
        default:
            oled_write("Undef", false);
    }
